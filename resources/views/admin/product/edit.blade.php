        ...
        <div class="col-md-8" >
            <h2 class="mt-4 text-center ">Edit Product</h2>
                ...
                <div class="row">
                        <div class="col-md-6" >                  
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{$products->name}}" style="box-shadow: 1px 2px 9px black;">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="price" class="form-label">Price</label>
                                <input type="number" step="any" class="form-control" id="price" name="price" value="{{$products->price}}" style="box-shadow: 1px 2px 9px black;">
                            </div>
                        </div>
                </div>     
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sub_cat_id" id="sub_cat_id" style="box-shadow: 1px 2px 9px black;">
                                    @foreach($sub_cats as $sub_cat)
                                        <option value="{{$sub_cat->id}}" <?php echo $sub_cat->id == $products->sub_cat_id ? 'selected' : '';?>>{{$sub_cat->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="6" style="box-shadow: 1px 2px 9px black;">{{$products->description}}</textarea>
                </div>
